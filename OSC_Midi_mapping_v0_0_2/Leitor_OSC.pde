...
/*
 * Como o formato OSC do Kinect Core Vision é idiota, tive
 * que fazer uma gambiarra no código pra ler as informações
 * em 10 formatos possiveis diferentes, para levar em conta
 * até a situação de 10 blobs detectados no palco... se eu
 * não fizesse isso não daria pra saber nem de um blob se
 * houvessem 10 blobs em cena...
 * enfim, gambiarra que justifica outra gambiarra
 */ 
